...
import type { QuizTakeDetailViewModel } from '@/types/quiz';
...
export default function ResultView() {
        ...
        const fetchResults = async () => {
            ...
            try {
                const response = await get(
                    `quizzes/PublicQuizTake/Get/${takeId}`,
                );
    ...
    const scorePercentage = Math.round(
        (results.score / results.questionNumber) * 100,
    );
            ...
            <div className="text-center space-y-4">
                ...
                <div className="space-y-2">
                    <p className="text-2xl font-semibold text-foreground">
                        {results.score}/{results.questionNumber} (
                        {scorePercentage}%)
                    </p>
                        ...
                        {results.quizTakeQuestions.map((question, index) => {
                            ...
                            switch (question.questionType) {
                                ...
                                case 4:
                                    questionContent = (
                                        <MatchTermAnswer
                                            quizTakeChildren={question.children}
                                            questionId={question.questionId}
                                        />
                                    );
                                    break;
                            ...
                            return (
                                <div
                                    key={index}
                                    className={`w-full rounded-lg border-2 px-4 py-3 transition-all duration-300 ${
                                        question.isCorrect
