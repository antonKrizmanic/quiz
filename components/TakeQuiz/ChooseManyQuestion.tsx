...
function ChooseManyQuestion({
    question,
    questionIndex,
    questionCount,
    onAnswer,
    initialAnswers,
}: ChooseManyQuestionProps) {
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
                {question.answers.map((option) => {
                    const isChecked = selectedAnswers.some(
                    ...
                    return (
                        <div key={option.id} className="group">
                            ...
                            <Label
                                ...
                                className={`flex items-center space-x-4 p-4 border-2 rounded-lg cursor-pointer transition-all duration-300 hover:border-primary-300 dark:hover:border-primary-400 hover:shadow-md ${
                                    isChecked
