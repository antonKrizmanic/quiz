        ...
        <div className="space-y-4">
            ...
            <div className="space-y-3">
                {answers.map((answer) => {
                    ...
                    const isWrong = givenAnswers && !answer.isCorrect && givenAnswers.some(x => x.id === answer.id);
                    ...
                    return (
                        <div key={answer.id} className="group">
                            ...
                            >
                                <div className={`flex-shrink-0 w-6 h-6 border-2 rounded-md flex items-center justify-center transition-all duration-300 ${isCorrect
